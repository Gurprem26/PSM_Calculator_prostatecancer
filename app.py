...
# --- PAGE CONFIGURATION ---
st.set_page_config(page_title="Singh PSM SHAP Calculator", page_icon="🩺", layout="centered")

st.title("The Singh-Miami PSM SHAP Calculator")
st.markdown("""
...
# 5. MRI (Aggregated Tiers based on your data)
